...
integer: #define SHIFT_BIT 1 #define CTRL_BIT  2 #define ALT_BIT   4
...
My Answer:
it is processed as: if (key_code & ((SHIFT_BIT | CTRL_BIT | ALT_BIT) == 0))
Correction: if ((key_code & (SHIFT_BIT | CTRL_BIT | ALT_BIT)) == 0)
