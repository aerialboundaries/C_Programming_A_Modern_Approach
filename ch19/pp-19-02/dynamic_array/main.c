 ...
 * described in Section 19.4. You may use any of the implementations of the
 * ADT described in that section.
 */
 ...
 * stack. The algorithm involves reading the operators and operands in an
 ...
 * The process continues until the user enters a character that is not
